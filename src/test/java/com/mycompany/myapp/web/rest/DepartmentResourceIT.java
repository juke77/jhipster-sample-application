...
public class DepartmentResourceIT {
    ...
    private static final String DEFAULT_TENTANT_ID = "AAAAAAAAAA";
    private static final String UPDATED_TENTANT_ID = "BBBBBBBBBB";
    ...
    public void createDepartment() throws Exception {
        ...
        assertThat(testDepartment.getTentantId()).isEqualTo(DEFAULT_TENTANT_ID);
    ...
    public void getAllDepartments() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tentantId").value(hasItem(DEFAULT_TENTANT_ID)))
    ...
    public void getDepartment() throws Exception {
        ...
        restDepartmentMockMvc.perform(get("/api/departments/{id}", department.getId()))
            ...
            .andExpect(jsonPath("$.tentantId").value(DEFAULT_TENTANT_ID))
    ...
    public void updateDepartment() throws Exception {
        ...
        Department testDepartment = departmentList.get(departmentList.size() - 1);
        assertThat(testDepartment.getTentantId()).isEqualTo(UPDATED_TENTANT_ID);
